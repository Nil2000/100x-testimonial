...
import PublicPageThemeBar from "@/components/public-page-theme-bar";
...
export default async function page({
  ...
  return (
    <div className="lg:max-w-[1000px] mx-auto w-full overflow-x-hidden space-y-4 flex flex-col justify-center">
      <PublicPageThemeBar />
